...
class Tribal:
    ...
    def fit(self, clonotypes, mode="refinement", transmat=None, cores=1, ilp_type=2):
        """
    ...
    def _refine(self, transmat, lt, isotype_labels):
        lt.refinement(isotype_labels, transmat=transmat, ilp_type=1)
        return lt
    

    def _refine_dag(self, transmat, lt, isotype_labels):
        lt.refinement(isotype_labels, transmat=transmat, ilp_type=2)
        return lt
